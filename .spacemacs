...
values."
  (setq-default
   ...
   ;; Set an Escape key replacement sequence
...
you should place your code here."
  ...
  (setq helm-projectile-switch-action #'helm-projectile-find-dir)
 )
